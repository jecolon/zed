...
const builtins = std.ComptimeStringMap(Value, .{
    ...
    .{ "keysByValueAsc", Value.new(.{ .builtin = .keysByValueAsc }, 0) },
    .{ "keysByValueDesc", Value.new(.{ .builtin = .keysByValueDesc }, 0) },
    ...
    .{ "sortAsc", Value.new(.{ .builtin = .sortAsc }, 0) },
    .{ "sortDesc", Value.new(.{ .builtin = .sortDesc }, 0) },
